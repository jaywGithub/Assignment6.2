 ...
 */
public class SizeCostRepositoryImpl extends SQLiteOpenHelper implements SizeCostRepository {

    public static final String TABLE_NAME = "sizecost";
    ...
    public SizeCostRepositoryImpl(Context context) {
    ...
    @Override
    public SizeCost findById(Long id) {
        ...
        if (cursor.moveToFirst()) {
            final SizeCost sizeCost = new SizeCost.Builder()
    ...
    @Override
    public SizeCost save(SizeCost entity) {
        ...
        SizeCost insertedEntity = new SizeCost.Builder()
                .copy(entity)
                .id(new Long(id))
                .build();
    ...
    @Override
    public SizeCost update(SizeCost entity) {
    ...
    @Override
    public SizeCost delete(SizeCost entity) {
    ...
    @Override
    public Set<SizeCost> findAll() {

        SQLiteDatabase db = this.getReadableDatabase();
        Set<SizeCost> sizeCosts = new HashSet<>();
        open();
